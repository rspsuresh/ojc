<?php /* Smarty version 2.6.26, created on 2018-07-20 20:25:48
         compiled from file:C:%5Cxampp%5Chtdocs%5Codc/plugins/blocks/user/block.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'file:C:\\xampp\\htdocs\\odc/plugins/blocks/user/block.tpl', 13, false),array('function', 'url', 'file:C:\\xampp\\htdocs\\odc/plugins/blocks/user/block.tpl', 21, false),array('modifier', 'escape', 'file:C:\\xampp\\htdocs\\odc/plugins/blocks/user/block.tpl', 18, false),)), $this); ?>
...
" size="12" class="textField" /></td>
						...
						<tr>
							<td colspan="1"><input type="submit" value="<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.login"), $this);?>
" class="button" /></td>
							<td colspan="1"><a style="padding-left: 0.5em;padding-right: 0.5em;background-color: #E8E8E1;
							color:black;border-bottom:2px solid gray;border-right: 1px solid gray" onclick="register()" class="reg">Register</a></td>
						</tr>
					</table>
				</form>
			<?php endif; ?>
    ...
    <script type="text/javascript">
        ...
        <!--
            function register() {
             window.location.href=$("#reglink").attr(\'href\');
            }
    // -->
    '; ?>
